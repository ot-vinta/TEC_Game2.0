...
public class TilePlacer : MonoBehaviour
{
    ...
    private bool PressedUnderButton()
    {
        ...
        Vector2 elementsRightUpPos = new Vector2(-1.38f + cameraPos.x, -3.6f + cameraPos.y);
        Vector2 exportRightDownPos = new Vector2(-6.085f + cameraPos.x, 4.06f + cameraPos.y);
        if (playButton != null) exportRightDownPos.x = -7.02f + cameraPos.x;
        Vector2 editLeftUpPos = new Vector2(6.08f + cameraPos.x, -4.06f + cameraPos.y);
        Vector2 PlayLeftDownPos = new Vector2(7.96f + cameraPos.x, 4.06f + cameraPos.y);
        Vector2 StatsLeftDownPos = new Vector2(8.42f + cameraPos.x, 3.14f + cameraPos.y);
